...
urlpatterns = [
    ...
    path('articles/publish/', views.publish_articles, name='publish-articles'),
    path('comments/approve/', views.approve_comments, name='approve-comments'),
    path('comments/approve/<int:post_id>/', views.approve_comments,
         name='approve-comments'),
    path('comment/approve/', views.approve_comment, name='approve-comment'),
